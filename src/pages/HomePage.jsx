...
const VisaLogo = (/* Pega el código SVG completo aquí */) => <svg>...</svg>;
const MasterCardLogo = (/* Pega el código SVG completo aquí */) => (
  <svg>...</svg>
);
...
function HomePage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      alert(
        "Registro Exitoso, pronto se comunicaran contigo para comenzar a invertir"
      );
    ...
    <>
      ...
      >
        <Card
          ...
          style={{ maxWidth: "1100px", border: "none" }}
        >
          <Row className="g-0">
            <Col lg={6} className="p-5 form-container-dark">
              <h2 className="fw-bold mb-3" style={{ color: "#D4AF37" }}>
                Inversiones INNOVATECORP
              </h2>
              ...
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Button
                  type="submit"
                  className="w-100 p-3 mt-3 btn-gold"
                  size="lg"
                  disabled={isLoading}
                >
                  {isLoading ? (
            ...
            >
              {/* Columna derecha */}
              <h1 className="display-5 fw-bold mb-3 text-on-image">
                Transforme su Futuro Financiero.
              </h1>
              <p className="lead mb-4 text-on-image">
                En{" "}
                <strong className="highlight-on-image">
                  Inversiones INNOVATECORP
                </strong>
                , le abrimos las puertas a oportunidades de inversión
                exclusivas.
              </p>
              <hr className="my-4" />
              <div className="mt-auto">
                <p className="text-on-image mb-2">
